...
HOLES = []
HOLES.append(SinusWave(x0=-200e-9, y0=150e-9, len=300e-9, gap=100e-9, deviation=25e-9, thickness=100e-9, tolerance=1e-9, inverted=False))
HOLES.append(SinusWave(x0=-200e-9, y0=350e-9, len=300e-9, gap=100e-9, deviation=25e-9, thickness=100e-9, tolerance=1e-9, inverted=True))
